<?php
    /**
    * Clase cliente
    * Gestiona el acceso de los datos referentes a los clientes
    **/
    class clientes_model{
        private $db; //conexión a la base de datos
        private $clientes; //Listado de clientes
        private $contactosc; //Listado de contactos del cliente
        private $facturasc; //Listado de facturas asociadas al cliente
        ...
        public function set_contacto($nuevo_contacto){
            //Inserción de nuevos contactos del cliente 
        ...
        public function set_cliente($nuevo_cliente){
            //Inserción de los datos del nuevo cliente 
